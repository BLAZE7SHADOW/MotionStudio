...
- **Guided first-run tour** — a 14-step walkthrough of the editor, resolved against the live DOM so context-only panels are covered on replay; replayable from the help menu
